            ...
            <table class="m-datatable" id="html_table" width="100%">
                ...
                @foreach($aircrafts as $aircraft)
                    <tr>
                        ...
                        <td >
                            <img style="width:120px;" src="{{ str_replace("/storage", "https://urgate.net/storage", Storage::url("app/public/".$aircraft->logo)) }}"/>
                        </td>
                        <td>
                            <a href="{{ route('editAircraft',['aircraft' => $aircraft->id]) }}"
                               class="btn btn-brand m-btn m-btn--icon m-btn--icon-only m-btn--custom m-btn--pill m-btn--air">
                                <i class="fa flaticon-edit-1"></i>
                            </a>
                            <a href="#!" data-url="{{ route('deleteAircraft',['aircraft' => $aircraft->id]) }}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        Are you sure that you want to remove this Aircraft ?
                    </p>
                </div>

...
<htmlpageheader name="page-header">
    <div class="outer_proxy">
        <img src="{{ $user->avatar ? url('/storage/app/public/'.$user->avatar) : asset('custom/images/avatar.jpg') }}"
             alt=""
            ...
            <tr>
                ...
                <td width="100">
                    <img class="img-rounded"
                         src="{{ $user->avatar ? url('/storage/app/public/'.$user->avatar) : asset('custom/images/avatar.jpg') }}"
                         alt=""

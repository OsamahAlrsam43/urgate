            ...
            <div class="head-section">
                <div class="headLeft-section">
                    <div class="headLeft-sub">
                        <input type="text" v-model="search" placeholder="Search..." @input="searchThreads">
                        <button @click="searchThreads"> <i class="fa fa-search"></i> </button>
                ...
                <div class="headRight-section" v-cloak>
                    <div class="headRight-sub">
                        ...
                        <h3 v-if="isSend">Send New Message</h3>
                    </div>
                </div>
            </div>
                        ...
                        <li v-for="thread in filteredThreads" @click="selectThread(thread)" :class="{ active : activeThread.id === thread.id }">
                            <div class="chatList">
                                <div class="desc">
                                    ...
                                    <h5>@{{thread.company ? thread.company : thread.name}}</h5>
                ...
                <div class="right-section">
                    ...
                    <div class="system-message mCustomScrollbar" data-mcs-theme="minimal-dark">
                        <ul :class="isSend && 'ml-3'">
                            <div class="row create-message pt-3" v-if="isSend">
                                <div class="col-md-6">
                                    <label class="mt-radio mt-radio-outline mr-3">
                                        <input type="radio" v-model="sendMode" value="all" checked/><span></span>
                                        All Users
                                    </label>
                                    <label class="mt-radio mt-radio-outline">
                                        <input type="radio" v-model="sendMode" value="specific"/><span></span>
                                        Specific Users
                                    </label>

                                    <div class="search-users" v-if="sendMode === 'specific'">
                                        <input type="text" class="form-control mb-2" placeholder="Search for user" @input="searchUsers" :class="searchLoading && 'loading'" />

                                        <span class="badge badge-pill badge-primary user-tag mr-2" v-for="user in users" @click="selectUser(user)">@{{ user.text }}</span>
                                    </div>

                                </div>
                                <div class="col-md-6" v-if="sendMode === 'specific'">
                                    <h6>Selected Users</h6>

                                    <ul class="user-list">
                                        <li v-for="user in selectedUsers">@{{ user.text }} <i class="fa fa-close float-right"></i></li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="right-section-bottom" :class="collapsed && 'collapsed'">
                        ...
                        <textarea name="message" placeholder="Type message here..." class="ckeditor"></textarea>
        ...
        var messaingApp = new Vue({
            ...
            methods: {
                ...
                getThreads: function () {
                    ...
                    axios.post('{{route("messages.threads")}}').then(response => {
                ...
                sendMessage: function () {
                    ...
                    axios.post('{{route('messages.send')}}', {
                        ...
                        CKEDITOR.instances.message.setData(null);
                        this.title = null;
                        this.sendMode = 'all';
                ...
                selectThread: function (thread) {
                    ...
                    this.selectedUsers = [{id: thread.id}];
                ...
                loadMessages: function () {
                    ...
                    axios.post('{{route("messages.messages")}}', {
